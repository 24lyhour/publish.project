...
const canProceedFromStep2 = computed(() => {
    return props.form.price && parseFloat(props.form.price) > 0
})
...
const completionProgress = computed(() => {
    ...
    if (props.form.name) progress += 20
    if (props.form.description) progress += 20
    if (props.form.price) progress += 20
    if (props.form.category_id) progress += 20
    if (props.form.quantity) progress += 20
