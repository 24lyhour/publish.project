...
<template>
    <AuthenticatedLayout title="Categories">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div class="flex items-center gap-6">
                            ...
                            <div>
                                ...
                                <p class="text-muted-foreground mt-1">Organize your products with categories</p>
                            </div>
                        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div class="border border-border rounded-lg p-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <div class="text-2xl font-bold text-foreground">{{ categories.data?.length || 0 }}</div>
                ...
                <div class="border border-border rounded-lg p-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <div class="text-2xl font-bold text-foreground">{{ activeCategories }}</div>
                ...
                <div class="border border-border rounded-lg p-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <div class="text-2xl font-bold text-foreground">{{ draftCategories }}</div>
                            <div class="text-sm text-muted-foreground">Draft Categories</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="border border-border rounded-lg p-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <div class="text-2xl font-bold text-foreground">{{ totalProducts }}</div>
                ...
                <div class="p-0">
                    ...
                    <div v-else class="overflow-x-auto">
                        <Table>
                            ...
                            <TableBody>
                                <TableRow v-for="item in categories.data" :key="item.id">
                                    <!-- Name Column -->
                                    <TableCell>
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <div v-if="item.type" class="text-sm text-muted-foreground">{{ item.type
                                                    }}
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!-- Description Column -->
                                    <TableCell>
                                        <div class="max-w-48 text-sm text-muted-foreground truncate">
                    ...
                    <!-- Simple Pagination -->
                    <div v-if="categories.data && categories.data.length > 0" class="border-t border-border px-6 py-4">
                        <div class="flex items-center justify-between">
                            <div class="text-sm text-muted-foreground">
        ...
        <SakalFormModal :show="showCreateModal" title="Create New Category" :form-data="form" action="" method="post"
            submit-text="Create Category" submit-icon="mdi-plus" :auto-submit="false" @close="handleCancelCreate"
            @cancel="handleCancelCreate" @submit="handleCreateSubmit">

            <template #default="{ form: modalForm, errors }">
